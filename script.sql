...
INSERT INTO FACULTIES(FACULTYNAME, FACULTYCODE) VALUES ('Computer and Informatics Faculty', 'BLG');
INSERT INTO FACULTIES(FACULTYNAME, FACULTYCODE) VALUES ('Civil Engineering Faculty', 'INS');
...
-- INSERT INTO GAMEFRIEND (NAME, TYPE, GAMEDATE, LOCATION, PLAYERNUMBER, DESCRIPTION) VALUES('Batak', 'Table Game', '2017-10-13', 'MED', 4, 'Come with your couple');
...
INSERT INTO CAMPUSLOCATIONS(CAMPUSNAME, CAMPUSDISTRICT) VALUES ('Ayazağa', 'Maslak');
INSERT INTO CAMPUSLOCATIONS(CAMPUSNAME, CAMPUSDISTRICT) VALUES ('Maçka', 'Taksim');
...
CREATE TABLE RESTAURANTMENUS (
    ...
    OWNERRESTAURANTID INTEGER REFERENCES RESTAURANTS(ID) NOT NULL
);
