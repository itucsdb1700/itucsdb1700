...
DROP TABLE IF EXISTS GAMEANNOUNCE;
...
INSERT INTO USERS(USERNAME, PASSWORD, EMAIL, NAME, SURNAME, FACULTYID) VALUES ('admin', '$6$rounds=656000$NhjGHwap0iYnsrNW$Y0sK0vHaShrBy0Q62GN3TIMQFdcDV7u98tjntyJUfN4EzDGKCr28UaG838uHaRNVCATFomj.d6gc.a1107lZm1', 'admin@gmail.com', 'server', 'admin', 14);
...
INSERT INTO SHAREDBOOKS(NAMEOFBOOK,LESSONNAME,LESSONCODE,TYPEOFSHARE,PRICE,USERID)VALUES('C HOW TO PROGRAM','Intr to Sci&Eng Comp (C)','BIL105E','Sell','30',1);
INSERT INTO SHAREDBOOKS(NAMEOFBOOK,LESSONNAME,LESSONCODE,TYPEOFSHARE,PRICE,USERID)VALUES('DISCRETE AND COMBINATORIAL MATHEMATICS','Discrete Mathematics','BLG112E','Sell','50',1);
...
INSERT INTO SHAREDLESSONNOTES(NAMEOFNOTES,LESSONNAME,LESSONCODE,TEACHERNAME,USERID)VALUES('NoSQL','DataBase Management Systems','BLG361E','Hayri Turgut Uyar',1);
INSERT INTO SHAREDLESSONNOTES(NAMEOFNOTES,LESSONNAME,LESSONCODE,TEACHERNAME,USERID)VALUES('QuickSort','Algorithms-1','BLG335E','Hazım Kemal Ekenel',1);
INSERT INTO SHAREDLESSONNOTES(NAMEOFNOTES,LESSONNAME,LESSONCODE,TEACHERNAME,USERID)VALUES('Polynomial Interpolation','Numerical Methods','BLG202E','Yusuf Yaslan',1);
...
-- Sample entries to GAMEANNOUNCE Entity.
...
INSERT INTO DATASHAREDHOUSE(LOCATION, RENTPRICE, NUMBEROFPEOPLE,NUMBEROFROOM,DESCRIPTION,USERID) VALUES ('Levent', '1500', '2','3+1','House wiil be shared with women student',1);
INSERT INTO DATASHAREDHOUSE(LOCATION, RENTPRICE, NUMBEROFPEOPLE,NUMBEROFROOM,DESCRIPTION,USERID) VALUES ('Maslak', '1000', '1','2+1','House wiil be shared with men student',1);
...
INSERT INTO DATASEARCHEDHOUSE(LOCATION, MINRENTPRICE, MAXRENTPRICE,DESCRIPTION,USERID) VALUES ('Levent', '300', '500', 'Searching Men HouseMate',1 );
INSERT INTO DATASEARCHEDHOUSE(LOCATION, MINRENTPRICE, MAXRENTPRICE,DESCRIPTION,USERID) VALUES ('HacıOsman', '400', '500', 'Searching Women HouseMate',1 );
...
INSERT INTO RESTAURANTS(RESTAURANTNAME ,LOCATIONID, MENUTYPE, RESTAURANTPOINT, OPENINGTIME, CLOSINGTIME, OWNEREMAIL, OWNERPHONENUMBER, SERVICETYPE )
  VALUES('Burger Restaurant' , 1, 'Fast Food', -1, '09:00', '00:00', 'sirma@gmail.com', '05456788890', 'Self' );

INSERT INTO RESTAURANTS(RESTAURANTNAME ,LOCATIONID, MENUTYPE, RESTAURANTPOINT, OPENINGTIME, CLOSINGTIME, OWNEREMAIL, OWNERPHONENUMBER, SERVICETYPE )
  VALUES('Mono Restaurant' , 1, 'Pizza', -1, '09:00', '23:00', 'mono@yahoo.com', '05426788890', 'Table Service' );
